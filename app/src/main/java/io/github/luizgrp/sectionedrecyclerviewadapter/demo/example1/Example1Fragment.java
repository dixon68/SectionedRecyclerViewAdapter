...
import io.github.luizgrp.sectionedrecyclerviewadapter.demo.info.SectionInfoItemFactory;
...
public class Example1Fragment extends Fragment implements ContactsSection.ClickListener {
    ...
    @Override
    public boolean onItemRootViewLongClicked(final ContactsSection section, final int itemAdapterPosition) {
        final SectionItemInfoDialog dialog = SectionItemInfoDialog.getInstance(
                SectionInfoItemFactory.create(itemAdapterPosition, sectionedAdapter),
